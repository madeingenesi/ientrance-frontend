...
export default function HomeSlider() {
  ...
  // Riproduce solo il video della slide attiva, le altre restano in pausa
  useEffect(() => {
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-[1000]">
          <div className="bg-white p-4 md:p-16 w-full max-w-2xl mx-4 relative splash flex flex-col gap-4">
            ...
            {/* div (con mb-4 come i p globali): il testo della prima slide contiene paragrafi */}
            <div className="leading-relaxed text-sm md:text-base h-[300px] md:h-auto overflow-y-auto pr-4 md:pr-0 mb-4">
              {slideContent[activeSlide]?.text}
            </div>
